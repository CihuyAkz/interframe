 ...
 *
 * <p>On NeoForge, Sodium discovers config pages by scanning for {@link ConfigEntryPointForge} (its
 * {@code ConfigLoaderForge}), NOT via the Fabric {@code sodium:config_api_user} entrypoint. The annotation
 * value is the owning mod id. This mirrors Foveate's integration exactly.
 */
@ConfigEntryPointForge(Interframe.MOD_ID)
